    ...
    public string GetStatusJson()
        => JsonSerializer.Serialize(
            new
            {
                ...
                treasureDoorFollowThroughActive = ExecutionService.TreasureDoorFollowThroughActive,
                treasureDoorFollowThroughTarget = ExecutionService.TreasureDoorFollowThroughTarget,
                treasureDoorFollowThroughStage = ExecutionService.TreasureDoorFollowThroughStage,
                treasureDoorFollowThroughReason = ExecutionService.TreasureDoorFollowThroughReason,
