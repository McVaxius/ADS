...
public static class RuleSemanticsCatalog
{
    ...
    [
        ...
        nameof(ObjectPriorityRule.Alliance),
    ...
    private static readonly IReadOnlyDictionary<string, string> EditorFieldLabels =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            [nameof(ObjectPriorityRule.Alliance)] = "Alliance",
    ...
    [
        ...
        ObjectEntry(nameof(InteractableClass.HyperFixatedAttackTarget), "HyperFixatedAttackTarget", "Give one solo-duty BattleNpc absolute target focus.", "Acquire FrenRider's hyper-focus lease, hard-target the exact live BattleNpc, and approach to 2.0y.", "Focus a user-configured solo-duty boulder or Trachtoum target.", waits: false),
        ...
        ObjectEntry(nameof(InteractableClass.CombatFriendly), "CombatFriendly", "Interact with a friendly target during combat.", "Direct-interact friendly BattleNpc/EventNpc. After a normal settled interaction, ADS suppresses that position until duty reset unless the progression object is explicitly repeatable.", "Talk to a Goblin Pathfinder during combat.", waits: true),
    ...
    private static RuleClassificationSemantics NoneEntry()
        => new(
            ...
            Matrix(
                ...
                (nameof(ObjectPriorityRule.Alliance), RuleFieldUse.Optional),
